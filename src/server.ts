...
io.on('connection', (socket: Socket) => {
  ...
  socket.on('send_is_answered_or_timer_finished', (data) => {
    console.log('send_is_answered_or_timer_finished DATA', data)
    socket.broadcast.emit('receive_is_answered_or_timer_finished', data)
  })
})
